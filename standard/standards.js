...
async function loadStandardCapabilities(opts = {}) {
    ...
    const machfabDir = path.join(standardDir, 'machfab');
    const capSchemaPath = path.join(standardDir, 'cap.schema.json');
    const mediaSchemaPath = path.join(standardDir, 'media.schema.json');
